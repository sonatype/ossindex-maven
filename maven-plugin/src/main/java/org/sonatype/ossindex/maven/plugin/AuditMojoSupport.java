    ...
    extends AbstractMojo
{
  ...
  @Parameter(defaultValue = "${maven.version}", required = true, readonly = true)
   ...
   * <a href="https://sonatype.github.io/ossindex-public/maven/apidocs/org/sonatype/ossindex/service/client/OssindexClientConfiguration.html">
   ...
   */
  protected abstract Set<Artifact> resolveDependencies(final MavenSession session)
      throws DependencyGraphBuilderException;

  /**
   * Resolve dependencies for a specific project.
   */
  protected Set<Artifact> resolveDependencies(final MavenSession session, final MavenProject project)
      throws DependencyGraphBuilderException
  {
    Set<Artifact> dependencies = new HashSet<>();
    getLog().debug("Resolving dependencies of: " + project);
   ...
   */
  @SuppressWarnings("Duplicates")
  protected void collectArtifacts(final Set<Artifact> artifacts, final DependencyNode node) {
