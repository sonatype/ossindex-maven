...
{{< command-output >}}
[INFO] --- ossindex-maven-plugin:3.0.0:audit (default-cli) @ vulnerable-fail ---
...
[INFO] ------------------------------------------------------------------------
[ERROR] Failed to execute goal org.sonatype.ossindex.maven:ossindex-maven-plugin:3.0.0:audit (default-cli) on project vulnerable-fail: Detected 1 vulnerable components:
...
{{< command-output >}}
[INFO] --- ossindex-maven-plugin:3.0.0:audit (default-cli) @ vulnerable-warn ---
[INFO] Checking for vulnerabilities:
[INFO]   commons-fileupload:commons-fileupload:jar:1.3:compile
[INFO]   commons-io:commons-io:jar:2.2:compile
[INFO] Exclude coordinates: []
